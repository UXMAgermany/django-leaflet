    ...
    L.drawVersion = "1.0.4", L.Draw = {}, L.drawLocal = {
        ...
        deleteLastVertex: function () {
            if (!(this._markers.length <= 1)) {
                var t = this._markers.pop(), e = this._poly,
                    i = e.getLatLngs(), o = i.splice(-1, 1)[0];
        ...
        _drawGuide: function (t, e) {
            var i, o, a,
                ...
                r = this.options.maxGuideLineLength, l = n > r ? n - r : s;
        ...
        _getTooltipText: function () {
            var t, e, i,
                ...
                a = this._shape, n = this.options.showArea;
        ...
        _onMouseMove: function (t) {
            var e, i = t.latlng, o = this.options.showRadius,
        ...
        options: {
            ...
            if (L.extend(e._origLatLng, e._latlng), i.options.poly) {
                ...
                if (!i.options.poly.allowIntersection && i.intersects()) {
                    ...
                    i.setStyle({color: this.options.drawError.color}), a && a.updateContent({text: L.drawLocal.draw.handlers.polyline.error}), setTimeout(function () {
                        i.setStyle({color: n}), a && a.updateContent({
            ...
            var i = this._poly._map, o = i.project(t.getLatLng()),
        ...
        L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
            geodesicArea: function (t) {
                ...
                var i = parseFloat(t).toFixed(e),
                    ...
                    a = o && o.delimiters, n = a && a.thousands,
                    s = a && a.decimal;
                if (n || s) {
                    var r = i.split(".");
        ...
        intersects: function () {
            ...
            var i = this._getProjectedPoints(), o = i ? i.length : 0,
                a = i ? i[o - 1] : null, n = o - 2;
        ...
        initialize: function (t) {
            ...
            var e, i = L.DomUtil.create("div", "leaflet-draw-section"), o = 0,
                a = this._toolbarClass || "", n = this.getModeHandlers(t);
            ...
            var e, i, o, a, n = this._actionsContainer, s = this.getActions(t),
                r = s.length;
